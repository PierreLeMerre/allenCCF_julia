...
# get hdf5 files
filelist1 = glob("*/*.nwb",src1)
filelist2 = glob("*/*.nwb",src2)
filelist3 = glob("*/*.nwb",src3)
filelist4 = glob("*/*.nwb",src4)
filelist5 = glob("*/*.nwb",src5)
...
prog = Progress(length(filelist), 1, "Looping through nwb files...", length(filelist))
